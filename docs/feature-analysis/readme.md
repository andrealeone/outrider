...
settled in [`specifics.md`](../../specifics.md), such as the no-TCP-listener stance,
the user-only socket trust model, or the Router isolation rule, they say so explicitly,
