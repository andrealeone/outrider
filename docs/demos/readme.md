...
- [`web-stack/`](web-stack/): four processes exercising dependencies
...
```bash
outrider on
outrider           # press m, enter docs/demos/web-stack, approve each process, y to apply
```

Then bring the services up from the dashboard and watch the start order gate:
